#ifndef STEPPER_CAN_NODE_HPP
#define STEPPER_CAN_NODE_HPP

#include <rclcpp/rclcpp.hpp>
#include <rclcpp/version.h>
#include "stepper_can/msg/o_drive_status.hpp"
...
using ODriveStatus = stepper_can::msg::ODriveStatus;
using ControllerStatus = stepper_can::msg::ControllerStatus;
using ControlMessage = stepper_can::msg::ControlMessage;

using AxisState = stepper_can::srv::AxisState;
using Empty = std_srvs::srv::Empty;

class StepperCanNode : public rclcpp::Node {
public:
    StepperCanNode(const std::string& node_name);
