...
#ifndef CUBEMARS_CAN__MSG__DETAIL__CONTROLLER_STATUS__FUNCTIONS_H_
#define CUBEMARS_CAN__MSG__DETAIL__CONTROLLER_STATUS__FUNCTIONS_H_
 ...
 * calls
 * cubemars_can__msg__ControllerStatus__init().
...
/**
 * It calls
 * cubemars_can__msg__ControllerStatus__fini()
 ...
 * cubemars_can__msg__ControllerStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cubemars_can__msg__ControllerStatus__Sequence__fini()
 * on the array,
...
#endif  // CUBEMARS_CAN__MSG__DETAIL__CONTROLLER_STATUS__FUNCTIONS_H_
