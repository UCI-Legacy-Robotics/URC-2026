...
: ${AMENT_CURRENT_PREFIX:="/home/pi/Legacy/URC-2026/embedded_ros2_ws/src/install/servo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo/environment/library_path.sh"
