...
#include "yellowjacket_can/msg/detail/o_drive_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yellowjacket_can::msg::ODriveStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yellowjacket_can::msg::ODriveStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yellowjacket_can::msg::ODriveStatus *>(
    untyped_ros_message);
...
{
  return &yellowjacket_can::msg::typesupport_fastrtps_cpp::_ODriveStatus__handle;
}
