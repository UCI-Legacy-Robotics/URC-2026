...
#ifndef YELLOWJACKET_CAN__MSG__DETAIL__CONTROLLER_STATUS__TRAITS_HPP_
#define YELLOWJACKET_CAN__MSG__DETAIL__CONTROLLER_STATUS__TRAITS_HPP_
...
[[deprecated("use yellowjacket_can::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const yellowjacket_can::msg::ControllerStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
  yellowjacket_can::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use yellowjacket_can::msg::to_yaml() instead")]]
inline std::string to_yaml(const yellowjacket_can::msg::ControllerStatus & msg)
{
  return yellowjacket_can::msg::to_yaml(msg);
}

template<>
inline const char * data_type<yellowjacket_can::msg::ControllerStatus>()
{
  return "yellowjacket_can::msg::ControllerStatus";
}

template<>
inline const char * name<yellowjacket_can::msg::ControllerStatus>()
{
  return "yellowjacket_can/msg/ControllerStatus";
}

template<>
struct has_fixed_size<yellowjacket_can::msg::ControllerStatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<yellowjacket_can::msg::ControllerStatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<yellowjacket_can::msg::ControllerStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YELLOWJACKET_CAN__MSG__DETAIL__CONTROLLER_STATUS__TRAITS_HPP_
