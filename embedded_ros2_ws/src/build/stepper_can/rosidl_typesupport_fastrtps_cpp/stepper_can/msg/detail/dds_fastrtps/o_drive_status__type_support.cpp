...
#include "stepper_can/msg/detail/o_drive_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stepper_can::msg::ODriveStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stepper_can::msg::ODriveStatus & ros_message)
{
  // Member: bus_voltage
  cdr >> ros_message.bus_voltage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stepper_can::msg::ODriveStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stepper_can::msg::ODriveStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stepper_can::msg::ODriveStatus *>(
    untyped_ros_message);
...
{
  return &stepper_can::msg::typesupport_fastrtps_cpp::_ODriveStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stepper_can, msg, ODriveStatus)() {
  return &stepper_can::msg::typesupport_fastrtps_cpp::_ODriveStatus__handle;
}
