...
#include "stepper_can/srv/detail/axis_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stepper_can::srv::AxisState_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stepper_can::srv::AxisState_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stepper_can::srv::AxisState_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_stepper_can
const rosidl_message_type_support_t *
get_message_type_support_handle<stepper_can::srv::AxisState_Request>()
{
  return &stepper_can::srv::typesupport_fastrtps_cpp::_AxisState_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stepper_can::srv::AxisState_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stepper_can::srv::AxisState_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stepper_can::srv::AxisState_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stepper_can::srv::typesupport_fastrtps_cpp::_AxisState_Response__handle;
}
...
{
  return &stepper_can::srv::typesupport_fastrtps_cpp::_AxisState__handle;
}
