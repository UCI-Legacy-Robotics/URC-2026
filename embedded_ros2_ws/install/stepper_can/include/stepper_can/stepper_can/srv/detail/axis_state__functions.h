...
#ifndef STEPPER_CAN__SRV__DETAIL__AXIS_STATE__FUNCTIONS_H_
#define STEPPER_CAN__SRV__DETAIL__AXIS_STATE__FUNCTIONS_H_
 ...
 * calls
 * stepper_can__srv__AxisState_Request__init().
...
/**
 * It calls
 * stepper_can__srv__AxisState_Request__fini()
 ...
 * stepper_can__srv__AxisState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * stepper_can__srv__AxisState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stepper_can__srv__AxisState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stepper_can
...
/**
 * It calls
 * stepper_can__srv__AxisState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_stepper_can
...
/**
 * It allocates the memory for the array and calls
 * stepper_can__srv__AxisState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stepper_can
...
/**
 * It calls
 * stepper_can__srv__AxisState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STEPPER_CAN__SRV__DETAIL__AXIS_STATE__FUNCTIONS_H_
