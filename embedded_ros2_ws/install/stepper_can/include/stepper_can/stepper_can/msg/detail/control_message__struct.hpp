...
#ifndef STEPPER_CAN__MSG__DETAIL__CONTROL_MESSAGE__STRUCT_HPP_
#define STEPPER_CAN__MSG__DETAIL__CONTROL_MESSAGE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__stepper_can__msg__ControlMessage __attribute__((deprecated))
#else
# define DEPRECATED__stepper_can__msg__ControlMessage __declspec(deprecated)
#endif
...
struct ControlMessage_
{
  ...
  // pointer types
  using RawPtr =
    stepper_can::msg::ControlMessage_<ContainerAllocator> *;
  using ConstRawPtr =
    const stepper_can::msg::ControlMessage_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      stepper_can::msg::ControlMessage_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__stepper_can__msg__ControlMessage
    std::shared_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__stepper_can__msg__ControlMessage
    std::shared_ptr<stepper_can::msg::ControlMessage_<ContainerAllocator> const>
...
using ControlMessage =
  stepper_can::msg::ControlMessage_<std::allocator<void>>;
...
#endif  // STEPPER_CAN__MSG__DETAIL__CONTROL_MESSAGE__STRUCT_HPP_
