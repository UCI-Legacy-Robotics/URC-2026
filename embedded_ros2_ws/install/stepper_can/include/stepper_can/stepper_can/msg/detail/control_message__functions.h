...
#ifndef STEPPER_CAN__MSG__DETAIL__CONTROL_MESSAGE__FUNCTIONS_H_
#define STEPPER_CAN__MSG__DETAIL__CONTROL_MESSAGE__FUNCTIONS_H_
 ...
 * calls
 * stepper_can__msg__ControlMessage__init().
...
/**
 * It calls
 * stepper_can__msg__ControlMessage__fini()
 ...
 * stepper_can__msg__ControlMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * stepper_can__msg__ControlMessage__Sequence__fini()
 * on the array,
...
#endif  // STEPPER_CAN__MSG__DETAIL__CONTROL_MESSAGE__FUNCTIONS_H_
