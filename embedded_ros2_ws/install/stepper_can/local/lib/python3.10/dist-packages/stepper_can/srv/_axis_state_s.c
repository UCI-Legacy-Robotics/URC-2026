...
bool stepper_can__srv__axis_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stepper_can.srv._axis_state.AxisState_Request", full_classname_dest, 45) == 0);
  }
  stepper_can__srv__AxisState_Request * ros_message = _ros_message;
...
PyObject * stepper_can__srv__axis_state__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stepper_can.srv._axis_state");
...
ROSIDL_GENERATOR_C_EXPORT
bool stepper_can__srv__axis_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stepper_can.srv._axis_state.AxisState_Response", full_classname_dest, 46) == 0);
  }
  stepper_can__srv__AxisState_Response * ros_message = _ros_message;
  {  // active_errors
