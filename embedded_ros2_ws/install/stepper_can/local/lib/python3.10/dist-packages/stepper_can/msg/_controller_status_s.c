...
bool stepper_can__msg__controller_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stepper_can.msg._controller_status.ControllerStatus", full_classname_dest, 51) == 0);
  }
  stepper_can__msg__ControllerStatus * ros_message = _ros_message;
  {  // pos_estimate
...
PyObject * stepper_can__msg__controller_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stepper_can.msg._controller_status");
