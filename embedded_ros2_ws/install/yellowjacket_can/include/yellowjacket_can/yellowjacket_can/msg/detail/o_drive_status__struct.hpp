...
#ifndef YELLOWJACKET_CAN__MSG__DETAIL__O_DRIVE_STATUS__STRUCT_HPP_
#define YELLOWJACKET_CAN__MSG__DETAIL__O_DRIVE_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__yellowjacket_can__msg__ODriveStatus __attribute__((deprecated))
#else
# define DEPRECATED__yellowjacket_can__msg__ODriveStatus __declspec(deprecated)
#endif
...
struct ODriveStatus_
{
  ...
  // pointer types
  using RawPtr =
    yellowjacket_can::msg::ODriveStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const yellowjacket_can::msg::ODriveStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      yellowjacket_can::msg::ODriveStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__yellowjacket_can__msg__ODriveStatus
    std::shared_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__yellowjacket_can__msg__ODriveStatus
    std::shared_ptr<yellowjacket_can::msg::ODriveStatus_<ContainerAllocator> const>
...
using ODriveStatus =
  yellowjacket_can::msg::ODriveStatus_<std::allocator<void>>;
...
#endif  // YELLOWJACKET_CAN__MSG__DETAIL__O_DRIVE_STATUS__STRUCT_HPP_
