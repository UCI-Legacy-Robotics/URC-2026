...
class Metaclass_AxisState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'yellowjacket_can.srv.AxisState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from yellowjacket_can.srv import _axis_state
...
class AxisState(metaclass=Metaclass_AxisState):
    from yellowjacket_can.srv._axis_state import AxisState_Request as Request
    from yellowjacket_can.srv._axis_state import AxisState_Response as Response
