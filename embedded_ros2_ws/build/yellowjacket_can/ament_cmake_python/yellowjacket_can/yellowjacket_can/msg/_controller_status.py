    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'yellowjacket_can.msg.ControllerStatus')
            logger.debug(
...
class ControllerStatus(metaclass=Metaclass_ControllerStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.pos_estimate = kwargs.get('pos_estimate', int())
        self.vel_estimate = kwargs.get('vel_estimate', int())
    ...
    def pos_estimate(self, value):
        if __debug__:
            assert \
                ...
                "The 'pos_estimate' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pos_estimate' field must be an integer in [-2147483648, 2147483647]"
    ...
    def vel_estimate(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'vel_estimate' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'vel_estimate' field must be an integer in [-2147483648, 2147483647]"
