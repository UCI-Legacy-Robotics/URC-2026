...
bool yellowjacket_can__msg__o_drive_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yellowjacket_can.msg._o_drive_status.ODriveStatus", full_classname_dest, 49) == 0);
  }
  yellowjacket_can__msg__ODriveStatus * ros_message = _ros_message;
  {  // bus_voltage
...
PyObject * yellowjacket_can__msg__o_drive_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yellowjacket_can.msg._o_drive_status");
