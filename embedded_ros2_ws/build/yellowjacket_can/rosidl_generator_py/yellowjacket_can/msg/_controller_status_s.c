...
bool yellowjacket_can__msg__controller_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yellowjacket_can.msg._controller_status.ControllerStatus", full_classname_dest, 56) == 0);
  }
  yellowjacket_can__msg__ControllerStatus * ros_message = _ros_message;
  {  // pos_estimate
    ...
    ros_message->pos_estimate = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // vel_estimate
    ...
    assert(PyLong_Check(field));
    ros_message->vel_estimate = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // torque_target
...
PyObject * yellowjacket_can__msg__controller_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yellowjacket_can.msg._controller_status");
  ...
  {  // pos_estimate
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->pos_estimate);
    {
  ...
  {  // vel_estimate
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->vel_estimate);
    {
