...
static const _ODriveStatus_type_support_symbol_names_t _ODriveStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yellowjacket_can, msg, ODriveStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yellowjacket_can, msg, ODriveStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yellowjacket_can, msg, ODriveStatus)() {
  return &::yellowjacket_can::msg::rosidl_typesupport_c::ODriveStatus_message_type_support_handle;
}
