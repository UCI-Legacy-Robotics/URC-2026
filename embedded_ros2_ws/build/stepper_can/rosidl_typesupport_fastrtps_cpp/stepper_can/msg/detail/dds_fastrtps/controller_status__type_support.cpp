...
#include "stepper_can/msg/detail/controller_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stepper_can::msg::ControllerStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stepper_can::msg::ControllerStatus & ros_message)
{
  // Member: pos_estimate
  cdr >> ros_message.pos_estimate;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stepper_can::msg::ControllerStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stepper_can::msg::ControllerStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stepper_can::msg::ControllerStatus *>(
    untyped_ros_message);
...
{
  return &stepper_can::msg::typesupport_fastrtps_cpp::_ControllerStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stepper_can, msg, ControllerStatus)() {
  return &stepper_can::msg::typesupport_fastrtps_cpp::_ControllerStatus__handle;
}
