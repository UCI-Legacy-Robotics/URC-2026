...
#include "stepper_can/msg/detail/control_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stepper_can::msg::ControlMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stepper_can::msg::ControlMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stepper_can::msg::ControlMessage *>(
    untyped_ros_message);
...
{
  return &stepper_can::msg::typesupport_fastrtps_cpp::_ControlMessage__handle;
}
