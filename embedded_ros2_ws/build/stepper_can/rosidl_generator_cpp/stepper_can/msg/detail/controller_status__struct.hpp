...
#ifndef STEPPER_CAN__MSG__DETAIL__CONTROLLER_STATUS__STRUCT_HPP_
#define STEPPER_CAN__MSG__DETAIL__CONTROLLER_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__stepper_can__msg__ControllerStatus __attribute__((deprecated))
#else
# define DEPRECATED__stepper_can__msg__ControllerStatus __declspec(deprecated)
#endif
...
struct ControllerStatus_
{
  ...
  // pointer types
  using RawPtr =
    stepper_can::msg::ControllerStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const stepper_can::msg::ControllerStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      stepper_can::msg::ControllerStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__stepper_can__msg__ControllerStatus
    std::shared_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__stepper_can__msg__ControllerStatus
    std::shared_ptr<stepper_can::msg::ControllerStatus_<ContainerAllocator> const>
...
using ControllerStatus =
  stepper_can::msg::ControllerStatus_<std::allocator<void>>;
...
#endif  // STEPPER_CAN__MSG__DETAIL__CONTROLLER_STATUS__STRUCT_HPP_
