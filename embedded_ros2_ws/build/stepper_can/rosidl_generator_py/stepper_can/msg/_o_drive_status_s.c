...
bool stepper_can__msg__o_drive_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stepper_can.msg._o_drive_status.ODriveStatus", full_classname_dest, 44) == 0);
  }
  stepper_can__msg__ODriveStatus * ros_message = _ros_message;
  {  // bus_voltage
...
PyObject * stepper_can__msg__o_drive_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stepper_can.msg._o_drive_status");
