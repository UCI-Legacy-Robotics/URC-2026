...
class Metaclass_AxisState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from stepper_can.srv import _axis_state
...
class AxisState(metaclass=Metaclass_AxisState):
    from stepper_can.srv._axis_state import AxisState_Request as Request
    from stepper_can.srv._axis_state import AxisState_Response as Response
