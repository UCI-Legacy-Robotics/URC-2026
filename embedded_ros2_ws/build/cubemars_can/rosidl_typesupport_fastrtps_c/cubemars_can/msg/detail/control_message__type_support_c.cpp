...
#include "cubemars_can/msg/detail/control_message__rosidl_typesupport_fastrtps_c.h"
...
using _ControlMessage__ros_msg_type = cubemars_can__msg__ControlMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: input_vel_rpm
  {
    cdr << ros_message->input_vel_rpm;
  }

  // Field name: input_pos_deg
  {
    cdr << ros_message->input_pos_deg;
  }

  // Field name: set_vel_limit_rpm
  {
    cdr << ros_message->set_vel_limit_rpm;
  }

  // Field name: set_accel_limit_rpm_s
  {
    cdr << ros_message->set_accel_limit_rpm_s;
  }

  // Field name: set_origin
  {
    cdr << ros_message->set_origin;
  }
...
size_t get_serialized_size_cubemars_can__msg__ControlMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name input_vel_rpm
  {
    size_t item_size = sizeof(ros_message->input_vel_rpm);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name input_pos_deg
  ...
  // field.name set_vel_limit_rpm
  {
    size_t item_size = sizeof(ros_message->set_vel_limit_rpm);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name set_accel_limit_rpm_s
  {
    size_t item_size = sizeof(ros_message->set_accel_limit_rpm_s);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name set_origin
  {
    size_t item_size = sizeof(ros_message->set_origin);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _ControlMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cubemars_can__msg__ControlMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cubemars_can
size_t max_serialized_size_cubemars_can__msg__ControlMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cubemars_can__msg__ControlMessage;
    is_plain =
      (
      offsetof(DataType, set_origin) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ControlMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cubemars_can__msg__ControlMessage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cubemars_can, msg, ControlMessage)() {
