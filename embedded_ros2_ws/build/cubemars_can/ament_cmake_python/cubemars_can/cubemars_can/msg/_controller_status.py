...
class ControllerStatus(metaclass=Metaclass_ControllerStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.vel_estimate_deg_per_s = kwargs.get('vel_estimate_deg_per_s', float())
    ...
    def __eq__(self, other):
        ...
        if self.pos_estimate_deg != other.pos_estimate_deg:
            return False
        if self.vel_estimate_deg_per_s != other.vel_estimate_deg_per_s:
            return False
    ...
    @builtins.property
    def vel_estimate_deg_per_s(self):
        """Message field 'vel_estimate_deg_per_s'."""
        return self._vel_estimate_deg_per_s

    @vel_estimate_deg_per_s.setter
    def vel_estimate_deg_per_s(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'vel_estimate_deg_per_s' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'vel_estimate_deg_per_s' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._vel_estimate_deg_per_s = value
