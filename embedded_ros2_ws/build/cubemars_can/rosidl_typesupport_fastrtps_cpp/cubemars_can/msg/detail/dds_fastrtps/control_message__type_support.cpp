...
#include "cubemars_can/msg/detail/control_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cubemars_can::msg::ControlMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cubemars_can::msg::ControlMessage & ros_message)
{
  // Member: control_mode
  cdr >> ros_message.control_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cubemars_can::msg::ControlMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cubemars_can::msg::ControlMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cubemars_can::msg::ControlMessage *>(
    untyped_ros_message);
...
get_message_type_support_handle<cubemars_can::msg::ControlMessage>()
{
  return &cubemars_can::msg::typesupport_fastrtps_cpp::_ControlMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cubemars_can, msg, ControlMessage)() {
  return &cubemars_can::msg::typesupport_fastrtps_cpp::_ControlMessage__handle;
}
