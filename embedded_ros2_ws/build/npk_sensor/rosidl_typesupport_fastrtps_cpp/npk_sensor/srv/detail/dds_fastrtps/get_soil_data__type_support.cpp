...
#include "npk_sensor/srv/detail/get_soil_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = npk_sensor::srv::GetSoilData_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const npk_sensor::srv::GetSoilData_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<npk_sensor::srv::GetSoilData_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetSoilData_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const npk_sensor::srv::GetSoilData_Request *>(
...
static size_t _GetSoilData_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetSoilData_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetSoilData_Request__callbacks = {
  "npk_sensor::srv",
  "GetSoilData_Request",
...
static rosidl_message_type_support_t _GetSoilData_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSoilData_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_npk_sensor
const rosidl_message_type_support_t *
get_message_type_support_handle<npk_sensor::srv::GetSoilData_Request>()
{
  return &npk_sensor::srv::typesupport_fastrtps_cpp::_GetSoilData_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = npk_sensor::srv::GetSoilData_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const npk_sensor::srv::GetSoilData_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<npk_sensor::srv::GetSoilData_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetSoilData_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const npk_sensor::srv::GetSoilData_Response *>(
...
static size_t _GetSoilData_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetSoilData_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetSoilData_Response__callbacks = {
  "npk_sensor::srv",
...
static rosidl_message_type_support_t _GetSoilData_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSoilData_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &npk_sensor::srv::typesupport_fastrtps_cpp::_GetSoilData_Response__handle;
}
...
static service_type_support_callbacks_t _GetSoilData__callbacks = {
  "npk_sensor::srv",
  "GetSoilData",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, npk_sensor, srv, GetSoilData_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, npk_sensor, srv, GetSoilData_Response)(),
...
static rosidl_service_type_support_t _GetSoilData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetSoilData__callbacks,
...
{
  return &npk_sensor::srv::typesupport_fastrtps_cpp::_GetSoilData__handle;
}
