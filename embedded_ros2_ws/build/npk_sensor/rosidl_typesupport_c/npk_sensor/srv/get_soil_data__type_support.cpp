...
static const _GetSoilData_Request_type_support_symbol_names_t _GetSoilData_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, npk_sensor, srv, GetSoilData_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, npk_sensor, srv, GetSoilData_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, npk_sensor, srv, GetSoilData_Request)() {
  return &::npk_sensor::srv::rosidl_typesupport_c::GetSoilData_Request_message_type_support_handle;
}
...
static const _GetSoilData_Response_type_support_symbol_names_t _GetSoilData_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, npk_sensor, srv, GetSoilData_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, npk_sensor, srv, GetSoilData_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, npk_sensor, srv, GetSoilData_Response)() {
  return &::npk_sensor::srv::rosidl_typesupport_c::GetSoilData_Response_message_type_support_handle;
}
...
static const _GetSoilData_type_support_symbol_names_t _GetSoilData_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, npk_sensor, srv, GetSoilData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, npk_sensor, srv, GetSoilData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, npk_sensor, srv, GetSoilData)() {
  return &::npk_sensor::srv::rosidl_typesupport_c::GetSoilData_service_type_support_handle;
}
