...
teleoperated, and Idle has no drive mode at all. Diagnostics isn't a
mission state and never appears here — it's an always-available tab
with no bearing on control mode. MainWindow
