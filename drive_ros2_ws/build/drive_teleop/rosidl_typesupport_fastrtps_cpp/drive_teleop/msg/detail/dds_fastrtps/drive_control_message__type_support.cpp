...
#include "drive_teleop/msg/detail/drive_control_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drive_teleop::msg::DriveControlMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drive_teleop::msg::DriveControlMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drive_teleop::msg::DriveControlMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DriveControlMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const drive_teleop::msg::DriveControlMessage *>(
...
static size_t _DriveControlMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DriveControlMessage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DriveControlMessage__callbacks = {
  "drive_teleop::msg",
  "DriveControlMessage",
...
static rosidl_message_type_support_t _DriveControlMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DriveControlMessage__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_drive_teleop
const rosidl_message_type_support_t *
get_message_type_support_handle<drive_teleop::msg::DriveControlMessage>()
{
  return &drive_teleop::msg::typesupport_fastrtps_cpp::_DriveControlMessage__handle;
}
