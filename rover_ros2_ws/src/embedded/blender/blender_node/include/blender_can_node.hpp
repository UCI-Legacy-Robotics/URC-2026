#ifndef BLENDER_CAN_NODE_HPP
#define BLENDER_CAN_NODE_HPP

#include <rclcpp/rclcpp.hpp>
#include <rclcpp/version.h>
#include "blender_can/msg/control_message.hpp"
...
using ControlMessage = blender_can::msg::ControlMessage;

class BlenderCanNode : public rclcpp::Node {
public:
    BlenderCanNode(const std::string& node_name);
